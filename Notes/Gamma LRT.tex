...
We now return to the problem of computing $\bP(W > w)$. Recalling Equation (\ref{eq:W_surv_raw}), this probability is
%
\begin{align}
    \bP \left\{ X^{\alpha - 1} \exp(-X / \gamma) > \frac{w}{c} \right\} 
\end{align}
%
From our analysis of the function $h$, we are now able to \textcolor{red}{START HERE}
